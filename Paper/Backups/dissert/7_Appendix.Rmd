...
```{r CAseries, echo=FALSE, out.width='85%', fig.align="center", fig.cap="Canada time series graph"}
knitr::include_graphics('../Data/Output/Graphs/All/Weighted_credit_gap_CA.pdf')
```

```{r FRseries, echo=FALSE, out.width='85%', fig.align="center", fig.cap="France time series graph"}
knitr::include_graphics('../Data/Output/Graphs/All/Weighted_credit_gap_FR.pdf')
```

```{r HKseries, echo=FALSE, out.width='85%', fig.align="center", fig.cap="Hong Kong time series graph"}
knitr::include_graphics('../Data/Output/Graphs/All/Weighted_credit_gap_HK.pdf')
```

```{r JPseries, echo=FALSE, out.width='85%', fig.align="center", fig.cap="Japan time series graph"}
knitr::include_graphics('../Data/Output/Graphs/All/Weighted_credit_gap_JP.pdf')
```

```{r KRseries, echo=FALSE, out.width='85%', fig.align="center", fig.cap="South Korea time series graph"}
knitr::include_graphics('../Data/Output/Graphs/All/Weighted_credit_gap_KR.pdf')
```

```{r SAseries, echo=FALSE, out.width='85%', fig.align="center", fig.cap="Saudi Arabia time series graph"}
knitr::include_graphics('../Data/Output/Graphs/All/Weighted_credit_gap_SA.pdf')
```

```{r SEseries, echo=FALSE, out.width='85%', fig.align="center", fig.cap="Sweden time series graph"}
knitr::include_graphics('../Data/Output/Graphs/All/Weighted_credit_gap_SE.pdf')
```

```{r CHseries, echo=FALSE, out.width='85%', fig.align="center", fig.cap="Switzerland time series graph"}
knitr::include_graphics('../Data/Output/Graphs/All/Weighted_credit_gap_CH.pdf')
```

```{r THseries, echo=FALSE, out.width='85%', fig.align="center", fig.cap="Thailand time series graph"}
knitr::include_graphics('../Data/Output/Graphs/All/Weighted_credit_gap_TH.pdf')
```
